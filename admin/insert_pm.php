...
$str="insert into product_master(p_name,p_title,img1,img2,img3,img4,img5) values('$p_name','$p_title','$img1','$img2','$img3','$img4','$img5')";
mysql_query($str);
...
header("location:admin_index.php?a=product");
?>